...
<div style="padding-bottom:100px;">
	...
	<table class="table">
		<tr>
			<td>
				<label>一级品类:</label>
				<select class="form-control" id="category1" f-type="combobox" f-options="errMsg:'必填',errDir:'bottom',required:true,select:function(d){
					$.getJSON(f.dynUrl+'',function(d){
						if(d.success){
	...
	<table class="table">
		<tr>
			<td style="width:20%">
				<label>sku:</label>
				<input class="form-control" name="sku" f-type="text" f-options="required:true,maxLength:32"/>
			</td>
			<td>
				<label>描述:</label>
